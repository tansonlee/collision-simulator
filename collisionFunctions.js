...
// // returns an object for thw two velocities
// const calculateElasticVelocity = (ball1, ball2) => {
// 	// calculate ball1 x
// 	const ball1FinalX = elasticFinalVelocity(
// 		ball1.mass,
// 		ball2.mass,
// 		ball1.vel.x,
// 		ball2.vel.x
...
// 	// calculate ball1 y
// 	const ball1FinalY = elasticFinalVelocity(
// 		ball1.mass,
// 		ball2.mass,
// 		ball1.vel.y,
// 		ball2.vel.y
...
// 	// calculate ball2 x
// 	const ball2FinalX = elasticFinalVelocity(
// 		ball2.mass,
// 		ball1.mass,
// 		ball2.vel.x,
// 		ball1.vel.x
...
// 	// calculate ball2 y
// 	const ball2FinalY = elasticFinalVelocity(
// 		ball2.mass,
// 		ball1.mass,
// 		ball2.vel.y,
// 		ball1.vel.y
...
// 	const ball1FinalVelocity = createVector(ball1FinalX, ball1FinalY);
// 	const ball2FinalVelocity = createVector(ball2FinalX, ball2FinalY);

// 	return { ball1FinalVelocity, ball2FinalVelocity };
// };
